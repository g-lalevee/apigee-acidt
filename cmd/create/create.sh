...
CREATE_RC=$(curl  -s -L -X POST -H "Authorization: Bearer $token" -H "content-type:application/json" "https://us-integrations.googleapis.com/v1/projects/$organization/locations/us/products/apigee/integrations/$name/versions" --data-binary "@$file" )
